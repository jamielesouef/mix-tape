...
- [x] Master checklist row current — the round's slices are `Done` except 016, which is `In review` with its blocker recorded (see the drift note in Section 4); 016 became `Done` later on 2026-09-05
