...
The first five rows were found during slice planning, before any slice started. **The last two came from S003**, which is the first entry here produced by evidence rather than by reading — and both are cases where a written assumption met 1175 real files and lost.
