...
//
    ...
    /// The Music tab: the album grid of the first music library. tvOS has no wallet (engineering doc
    /// §1.1); slice 011 gives this grid its shelf chrome.
